...
def tuned_make_logistic_quota_function(self, params):
    """
...
def tuned_make_logistic_incentive_function(self, params):
    """
...
def tuned_generate_individuals_for_logistic(self):
    """
