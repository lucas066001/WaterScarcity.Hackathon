...
def tuned_make_exponential_quota_function(self, params):
    """
...
def tuned_make_exponential_incentive_function(self, params):
    """
...
def tuned_generate_individuals_for_exponential(self):
    """
